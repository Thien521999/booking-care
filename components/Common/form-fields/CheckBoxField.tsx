...
export const NewIcon = (props: any) => (
...
export const NewIconChecked = (props: any) => (
  <svg {...props} width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_3253_59257)">
      <rect width="15" height="15" fill="#EB342E" />
...
export const CheckBoxField = ({ name, width, disabled, control, label, values }: CheckBoxFieldProps) => {
  return (
